...
const menu = [
    { label: 'Dashboard', path: '/supply-cordinator/dashboard', icon: LayoutDashboard },
    { label: 'Inventory', path: '/supply-cordinator/inventory', icon: CirclePile },
    { label: 'Reports', path: '/supply-cordinator/report', icon: NotepadText },
    { label: "Profile", path: "/supply-cordinator/profile", icon: User }
]

export default function SupplyCordinatorSidebar() {
    return (
